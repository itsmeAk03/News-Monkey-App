    ...
    return (
      <div>
        ...
        <Routes>
          ...
          <Route exact path="/business" element={<News key="buiseness" pageSize={this.pageSize} country={this.country} category="business" />} />
          <Route exact path="/entertainment" element={<News key="entertainement" pageSize={this.pageSize} country={this.country} category="entertainment" />} />
